	...
	addDetails(guide) {
		return (<article className="guide-details">
			...
			<div className="guide-instructions">
				...
				<p>Get the TODO to TODO using <a href="https://transportnsw.info/trip#/?to=TODO" target="_system">transportnsw.info</a>. Plan your return trip from TODO at <a href="https://transportnsw.info/trip#/?to=TODO" target="_system">transportnsw.info</a>.</p>
				<h2>Along the way</h2>
			</div>
			...
			<div className="guide-instructions">
				<h2>What to bring</h2>
				<ul>
					<li>Check the <a href="http://www.nationalparks.nsw.gov.au/alert/state-alerts" target="_system">national parks website</a> for possible detours, closures and restrictions.</li>
					<li>Install an OpenStreetMap app for <a href="http://wiki.openstreetmap.org/wiki/Android" target="_system">Android</a> or <a href="http://wiki.openstreetmap.org/wiki/Apple_iOS" target="_system">iOS</a> and preload the area.</li>
					<li>Download the <a href="./inc/gpx/TODO.gpx" target="_system">GPS data</a> if your device can import it.</li>
